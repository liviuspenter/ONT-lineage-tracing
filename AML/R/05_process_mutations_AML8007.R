...
p=DimPlot(subset(AML8007, orig.ident == 'AML8007.1'), reduction = 'ref.umap', 
          cells.highlight = list('mutated' = DNMT3A.vaf$bc[which(DNMT3A.vaf$mutated == 'mutated')], 
...
q=DimPlot(subset(AML8007, orig.ident == 'AML8007.4'), reduction = 'ref.umap', 
          cells.highlight = list('mutated' = DNMT3A.vaf$bc[which(DNMT3A.vaf$mutated == 'mutated')], 
                                 'wildtype' = DNMT3A.vaf$bc[which(DNMT3A.vaf$mutated == 'wildtype')]),
          cols.highlight = c('wildtype' = 'black', 'mutated' = 'firebrick'), sizes.highlight = 1) +
  NoLegend() + 
