...
p <- DimPlot(subset(AML3003.14, orig.ident == "AML3003.1"),
  reduction = "ref.umap",
...
q <- DimPlot(subset(AML3003.14, orig.ident == "AML3003.4"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = STAG2.vaf$bc[which(STAG2.vaf$mutated == "mutated")],
    "wildtype" = STAG2.vaf$bc[which(STAG2.vaf$mutated == "wildtype")]
...
p <- DimPlot(subset(AML3003.14, orig.ident == "AML3003.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = TET2.2.vaf$bc[which(TET2.2.vaf$mutated == "mutated")],
...
p <- DimPlot(subset(AML3003.14, orig.ident == "AML3003.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = TET2.3.vaf$bc[which(TET2.3.vaf$mutated == "mutated")],
...
p <- DimPlot(subset(AML3003.14, orig.ident == "AML3003.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = TET2.4.vaf$bc[which(TET2.4.vaf$mutated == "mutated")],
