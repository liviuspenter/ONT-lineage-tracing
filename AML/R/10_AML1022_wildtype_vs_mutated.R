...
p <- DimPlot(AML1022.1,
  reduction = "ref.umap", cells.highlight = list("mutated" = DNMT3A.mutated.cells, "wildtype" = DNMT3A.wildtype.cells),
...
p <- DimPlot(AML1022.1,
  reduction = "ref.umap", cells.highlight = list("mutated" = DNMT3A.mutated.cells, "wildtype" = RUNX1.wildtype.cells),
...
p <- DimPlot(AML1022.1,
  reduction = "ref.umap", cells.highlight = list("mutated" = DNMT3A.mutated.cells, "wildtype" = SF3B1.wildtype.cells),
...
boo <- DNMT3A.vaf %>%
  ...
  summarize(
    mutated = length(which(mutated == "mutated")),
