...
p=DimPlot(subset(AML1007, orig.ident == 'AML1007.1'), reduction = 'ref.umap', 
          cells.highlight = list('mutated' = ASXL1.vaf$bc[which(ASXL1.vaf$mutated == 'mutated')], 
...
q=DimPlot(subset(AML1007, orig.ident == 'AML1007.3'), reduction = 'ref.umap', 
          cells.highlight = list('mutated' = ASXL1.vaf$bc[which(ASXL1.vaf$mutated == 'mutated')], 
                                 'wildtype' = ASXL1.vaf$bc[which(ASXL1.vaf$mutated == 'wildtype')]),
          cols.highlight = c('wildtype' = 'black', 'mutated' = 'firebrick'), sizes.highlight = 1) +
  NoLegend() + 
...
p=DimPlot(subset(AML1007, orig.ident == 'AML1007.1'), reduction = 'ref.umap', 
          cells.highlight = list('mutated' = SRSF2.vaf$bc[which(SRSF2.vaf$mutated == 'mutated')], 
...
q=DimPlot(subset(AML1007, orig.ident == 'AML1007.3'), reduction = 'ref.umap', 
  ...
  NoAxes() + 
  theme(plot.title = element_blank())
r=DimPlot(subset(AML1007, orig.ident == 'AML1007.5'), reduction = 'ref.umap', 
          cells.highlight = list('mutated' = SRSF2.vaf$bc[which(SRSF2.vaf$mutated == 'mutated')], 
                                 'wildtype' = SRSF2.vaf$bc[which(SRSF2.vaf$mutated == 'wildtype')]),
          cols.highlight = c('wildtype' = 'black', 'mutated' = 'firebrick'), sizes.highlight = 1) +
  NoLegend() + 
