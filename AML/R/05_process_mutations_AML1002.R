...
p <- DimPlot(subset(AML1002, orig.ident == "AML1002.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = IDH1_1.vaf.1$bc[which(IDH1_1.vaf.1$mutated == "mutated")],
...
q <- DimPlot(subset(AML1002, orig.ident == "AML1002.3"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = IDH1_1.vaf.3$bc[which(IDH1_1.vaf.3$mutated == "mutated")],
...
p <- DimPlot(subset(AML1002, orig.ident == "AML1002.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = IDH1_2.vaf.1$bc[which(IDH1_2.vaf.1$mutated == "mutated")],
...
q <- DimPlot(subset(AML1002, orig.ident == "AML1002.3"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = IDH1_2.vaf.3$bc[which(IDH1_2.vaf.3$mutated == "mutated")],
...
p <- DimPlot(subset(AML1002, orig.ident == "AML1002.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = TET2.vaf$bc[which(TET2.vaf$mutated == "mutated")],
...
p <- DimPlot(subset(AML1002, orig.ident == "AML1002.1"),
  reduction = "ref.umap",
  cells.highlight = list(
    "mutated" = U2AF1.vaf$bc[which(U2AF1.vaf$mutated == "mutated")],
