...
samples = c('ETV001', 'ETV002', 'ETV003', 'ETV004', 'ETV005', 'PH001', 'PH002','ETV6-RUNX1_1','ETV6-RUNX1_2', 'ETV6-RUNX1_3', 'ETV6-RUNX1_4', 
...
anchors <- FindTransferAnchors(reference = bm, query = ALL.validation, k.filter = NA, reference.reduction = "spca", 
                               reference.neighbors = "spca.annoy.neighbors", dims = 1:50)
ALL.validation <- MapQuery(anchorset = anchors, ALL.validation, reference = bm, 
